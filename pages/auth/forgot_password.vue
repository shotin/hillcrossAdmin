...
<template>
    <div class="row vh-100 vw-100 position-relative mx-0">
      ...
      <div class="col-sm-10 col-md-8 pt-20 mx-0 my-auto main-div px-0">
        ...
        <h6 class="login-intro">Forget Password</h6>
        <form  class="my-10 mt-16" @submit.prevent="forgotPassword()">
          <div class="main-fields">

            <div class="form-group">
              <label class="text-label" for="exampleInputEmail1">ID/Email:</label>
