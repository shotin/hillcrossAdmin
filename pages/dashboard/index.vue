      ...
      <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ul class="nav nav-tabs page-header-tab">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#admin-Activity"
                >Activity</a
              >
            </li>
          </ul>
                    ...
                    <div class="d-sm-flex justify-content-between">
                      <div class="font-12 mb-2">
                        <span
                          ...
                          Revenue. <a href="#">Learn More</a></span
                        >
                      </div>
                  ...
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-xl-3 col-md-6 mb-2">
                        ...
                        <span class="text-uppercase font-10"
                          >Compared to last year</span
                        >
                      </div>
                      <div class="col-xl-3 col-md-6 mb-2">
                        <div class="clearfix">
                ...
                <div class="card">
                  ...
                  <div class="card-footer d-flex justify-content-between">
                    <div class="font-14">
                      <span
                        >Measure How Fast You’re Growing Monthly Recurring
                        Revenue. <a href="#">View All</a></span
                      >
                    </div>
                    <div>
              ...
              <div class="col-xl-5 col-lg-6 col-md-12">
                <div class="card">
                    ...
                    <table class="table table-striped mt-4">
                      <tbody>
                        <tr>
                          <td>
                            <label class="d-block"
                              >Mechanical Engineering<span class="float-right"
                                >43%</span
                              ></label
                            >
                            <div class="progress progress-xs">
                        ...
                        <tr>
                          <td>
                            <label class="d-block"
                              ...
                              <span class="float-right">27%</span></label
                            >
                            <div class="progress progress-xs">
                              <div
                        ...
                        <tr>
                          <td>
                            <label class="d-block"
                              ...
                              <span class="float-right">81%</span></label
                            >
                            <div class="progress progress-xs">
                              <div
                        ...
                        <tr>
                          <td>
                            <label class="d-block"
                              >Management - MGT
                              <span class="float-right">61%</span></label
                            >
                            <div class="progress progress-xs">
                              <div
                                class="progress-bar bg-pink"
                  ...
                  <div class="card-footer">
                    <small
                      >Measure How Fast You’re Growing Monthly Recurring
                      Revenue. <a href="#">Learn More</a></small
                    >
                  </div>
                </div>
              </div>
                    ...
                    >
                      ...
                      <tbody>
                          ...
                          <td>
                            <label class="custom-control custom-checkbox">
                              ...
                              <span class="custom-control-label"
                                >Report Panel Usag</span
                              >
                            </label>
                          </td>
                          <td class="text-right">Feb 12-2019</td>
                          <td>
                            <span class="tag tag-danger ml-0 mr-0">HIGH</span>
                          </td>
                          <td>
                            <span
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="tag tag-warning ml-0 mr-0">MED</span>
                          </td>
                          <td>
                            <img
                              src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar1.jpg"
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="tag tag-success ml-0 mr-0">High</span>
                          </td>
                          <td>
                            <img
                              src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar2.jpg"
