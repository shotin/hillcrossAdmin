<template>
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-6" v-if="hasStudyMode">
      <div class="input-group">
        <select name="" id="" v-model="form.study_mode" class="form-control">
...
export default {
  ...
  methods: {
    ...
    runFilter() {
      ...
      if (!this.form.academic_calender) {
        delete this.form.academic_calender;
      }
      if (!this.form.search) {
        delete this.form.search;
      }
      if (!this.form.study_mode) {
        delete this.form.study_mode;
      }
      if (this.form.school) {
