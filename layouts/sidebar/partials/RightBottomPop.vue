<template>
  <div class="user_div">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#righttab-statistics"
          >Statistics</a
        >
      </li>
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#righttab-Result">Result</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#righttab-Students"
          >Student</a
        >
      </li>
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#righttab-Todo">Todo</a>
      </li>
    </ul>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex">
              ...
              <div class="ml-auto">
                <i class="fa fa-caret-up text-success"></i>4%
              </div>
            </div>
          </div>
            ...
            <ul class="list-unstyled">
              <li class="mb-3">
                <div class="clearfix">
                  ...
                  <div class="float-right">
                    <small class="text-muted">Art & Design</small>
                  </div>
                </div>
                <div class="progress progress-xxs">
                  <div
              ...
              <li class="mb-3">
                <div class="clearfix">
                  ...
                  <div class="float-right">
                    <small class="text-muted">Sports Science</small>
                  </div>
                </div>
                <div class="progress progress-xxs">
                  <div
              ...
              <li>
                <div class="clearfix">
                  ...
                  <div class="float-right">
                    <small class="text-muted">Biological Sciences</small>
                  </div>
                </div>
                <div class="progress progress-xxs">
                  <div
      ...
      <div class="tab-pane fade" id="righttab-Students" role="tabpanel">
          ...
          <ul class="right_chat list-unstyled list">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar1.jpg"
                  alt=""
                />
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar2.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar3.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar4.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar5.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar6.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar7.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar8.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar9.jpg"
                  alt=""
                />
                <div class="media-body">
            ...
            <li>
              <a href="javascript:void(0);" class="media">
                <img
                  class="media-object"
                  src="https://nsdbytes.com/template/ericssion/assets/images/xs/avatar10.jpg"
                  alt=""
                />
                <div class="media-body">
        ...
        <div class="user_chatbody chat_app">
          <div class="card-header bline pt-1 pl-0 pr-0">
            ...
            <div class="card-options">
              <a href="javascript:void(0)" class="p-1" data-toggle="dropdown"
                ><i class="fa fa-cog"></i
              ></a>
              <div
              ...
              <a href="javascript:void(0)" class="p-1 chat_close"
            ...
            <ul class="mb-0">
              ...
              <li class="other-message">
                ...
                <div class="message">
                  <div class="media_img">
                    <img
                      src="https://nsdbytes.com/template/ericssion/assets/images/gallery/1.jpg"
                      class="w100 img-thumbnail"
                      alt=""
                    />
                    <img
                      src="https://nsdbytes.com/template/ericssion/assets/images/gallery/2.jpg"
                      class="w100 img-thumbnail"
                      alt=""
                    />
                  </div>
          ...
          <li>
            <label class="custom-control custom-checkbox">
              ...
              <span class="custom-control-label"
                >New logo design for Angular Admin</span
              >
            </label>
          </li>
          <li>
            <label class="custom-control custom-checkbox">
              ...
              />
              <span class="custom-control-label"
                >Design PSD files for Angular Admin</span
              >
            </label>
          </li>
          <li>
