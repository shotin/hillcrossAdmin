<template>
  <div id="rightsidebar" class="right_sidebar">
    ...
    <div class="tab-content">
      <div
        role="tabpanel"
        class="tab-pane vivify fadeIn active"
        id="Settings"
        aria-expanded="true"
      >
        <div class="mb-4">
        ...
        <div>
          <h6 class="font-14 font-weight-bold mt-4 text-muted">
            General Settings
          </h6>
        ...
        <div class="form-group">
          <label class="d-block"
            >Storage <span class="float-right">77%</span></label
          >
